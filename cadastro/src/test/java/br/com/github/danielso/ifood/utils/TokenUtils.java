package br.com.github.danielso.ifood.utils;
...
public class TokenUtils {
	 ...
	 * signed by the privateKey.pem test resource key.
	 *
	 ...
	 *
	 * @param jsonResName   - name of test resources file
	 * @param invalidClaims - the set of claims that should be added with invalid
	 *                      values to test failure modes
	 * @return the JWT string
	 * @throws Exception on parse failure
	 */
	...
	public static String generateTokenString(PrivateKey pk, String kid, String jsonResName,
		...
		// If the exp claim is not updated, it will be an old value that should be seen
		// as expired
	...
	/**
	 * Enums to indicate which claims should be set to invalid values for testing
	 * failure modes
	 */
